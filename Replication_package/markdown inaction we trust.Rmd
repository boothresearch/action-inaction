...
data1 <- read.csv(file.path("data", "inactionwetrust_study1.csv"), na.strings=c("","NA"))
...
Sa1preferenceplot
ggsave(file.path("output", "Study1a-preference.png"), dpi = 600, scale = 1.7)
...
Sa1competenceplot
ggsave(file.path("output", "Study1a-competence.png"), dpi = 600, scale = 1.7)
...
Sa1normativeplot
ggsave(file.path("output", "Study1a-norms.png"), dpi = 600, scale = 1.7)
...
Sa1regretplot
ggsave(file.path("output", "Study1a-regret.png"), dpi = 600, scale = 1.7)

# two in one
library(ggpubr)
ggarrange(Sa1preferenceplot, Sa1competenceplot, Sa1normativeplot, Sa1regretplot, common.legend = TRUE)
ggsave(file.path("output", "Study1a-4 in one.png"), width = 11, height = 10, dpi = 600, scale = 1)
...
S1bpreferenceplot
ggsave(file.path("output", "Study1b-preference.png"), dpi = 600, scale = 1.7)
...
S1bcompetenceplot
ggsave(file.path("output", "Study1b-competence.png"), dpi = 600, scale = 1.7)
...
S1bnormativeplot
ggsave(file.path("output", "Study1b-norms.png"), dpi = 600, scale = 1.7)
...
S1bregretplot
ggsave(file.path("output", "Study1b-regret.png"), dpi = 600, scale = 1.7)

# two in one
library(ggpubr)
ggarrange(S1bpreferenceplot, S1bcompetenceplot, S1bnormativeplot, S1bregretplot, common.legend = TRUE)
ggsave(file.path("output", "Study1b-4 in one.png"), width = 11, height = 10, dpi = 600, scale = 1)
...
S2preferenceplot
ggsave(file.path("output", "Study2-preference.png"), dpi = 600, scale = 1.7)
...
S2competenceplot
ggsave(file.path("output", "Study2-competence.png"), dpi = 600, scale = 1.7)
...
S2desnormativeplot
ggsave(file.path("output", "Study2-descriptive-norms.png"), dpi = 600, scale = 1.7)
...
S2injnormativeplot
ggsave(file.path("output", "Study2-injunctive-norms.png"), dpi = 600, scale = 1.7)
...
S2regretplot
ggsave(file.path("output", "Study2-regret.png"), dpi = 600, scale = 1.7)
...
S2joyplot
ggsave(file.path("output", "Study2-joy.png"), dpi = 600, scale = 1.7)
...
ggsave(file.path("output", "Study2-control-6 in one.png"), width = 12, height = 18, dpi = 600, scale = 1)
...
S2anovapreference
ggsave(file.path("output", "Study2-anova-preference.png"), dpi = 600, scale = 1)
...
S2anovacompetence
ggsave(file.path("output", "Study2-anova-competence.png"), dpi = 600, scale = 1)
...
S2anovadescnorms
ggsave(file.path("output", "Study2-anova-descnorms.png"), dpi = 600, scale = 1)
...
S2anovainjnorms
ggsave(file.path("output", "Study2-anova-injnorms.png"), dpi = 600, scale = 1)
...
S2anovaregret
ggsave(file.path("output", "Study2-anova-regret.png"), dpi = 600, scale = 1)
...
S2anovajoy
ggsave(file.path("output", "Study2-anova-joy.png"), dpi = 600, scale = 1)

# six in one
library(ggpubr)
ggarrange(S2anovapreference, S2anovacompetence, S2anovadescnorms, S2anovainjnorms, S2anovaregret, S2anovajoy)
ggsave(file.path("output", "Study2-anova-6 in one.png"), width = 15, height = 10, dpi = 600, scale = 1)
...
apa.cor.table(nopriorcorrdf, filename=file.path("output", "nopriorcorrelation.doc"),show.conf.interval = TRUE, show.sig.stars = FALSE, landscape = TRUE)
apa.cor.table(positivepriorcorrdf, filename=file.path("output", "positivepriorcorrelation.doc"),show.conf.interval = TRUE, show.sig.stars = FALSE, landscape = TRUE)
apa.cor.table(negativepriorcorrdf, filename=file.path("output", "negativepriorcorrelation.doc"),show.conf.interval = TRUE, show.sig.stars = FALSE, landscape = TRUE)
